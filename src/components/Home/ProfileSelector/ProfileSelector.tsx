	...
	return (
		<div>
			<div className="bg-blue-darker-blue rounded-md p-4 pt-2 md:max-w-xs">
				...
				<div className="mt-4">
					<Button className="mt-2" color='text-white-white' bgColor='bg-pink-dark-pink' bgColorHover='bg-pink-light-pink' size='normal' icon={faRandom} onClick={randomizeAvatar}>{t('profileSelector.randomize')}</Button>
